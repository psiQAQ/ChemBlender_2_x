...
from cbq_core.model import ImportBatch as _ImportBatch
from cbq_core.model import QCProject as _QCProject
from cbq_core.sidecar_migrations import CURRENT_PROJECT_SCHEMA_VERSION as _CURRENT_PROJECT_SCHEMA_VERSION
from chemblender_prepare.reader_api.public_model import PublicImportBatch as _PublicImportBatch
from chemblender_prepare.reader_api.public_model import _validate_public_batch_values
...
_BATCH_FIELDS = (
    "sources", "source_revisions", "structures", "topologies", "molecular_records",
    "biological_hierarchies", "annotations", "external_references", "cif_envelopes",
