...
from chemblender_prepare.core.pyprocar_adapter import _faces
from chemblender_prepare.core.pyprocar_adapter import _package_version
...
def parse_vasp_fermi(source_directory, *, spin_index=0, interpolation_factor=1,
    ...
    provenance_id = uuid4()
    from cbq_core.element_data import ELEMENTS_DEFAULT
    from chemblender_prepare.core.ase_adapter import _site_labels
