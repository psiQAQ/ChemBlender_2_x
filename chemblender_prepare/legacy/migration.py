...
from cbq_core.model import fractional_to_cartesian
from cbq_core.model_registry import model_type_tag
from cbq_core.storage.publication import solidify_session
from cbq_core.sidecar import LazyNpyArray, _array_content_hash, close_project
...
def plan_legacy_migration(extraction_report, base_project):
    ...
    for snapshot in extraction_report.objects:
        ...
        record = ProvenanceRecord(id=uuid4(), revision=_REVISION, producer="chemblender_prepare", producer_version="0.1.0",
