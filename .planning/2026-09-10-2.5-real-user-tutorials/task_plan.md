...
- Next Step: P4.12 修复 T06 历史 invalid manifest，复用 run-013 当前候选直接 GUI 标量证据并只补必要授权重放链
...
下列已勾选项表示相应操作或审计已执行，不表示全部 P0 案例技术验收完成。T00/T01/T02/T04 当前 manifest 已通过完整性与技术门槛，但独立审阅仍为 `incomplete`；T06 历史 manifest 为 `invalid`，T07/T17/T18 尚无 conforming manifest。
