...
from ChemBlender.core import (
    AtomicProperty, BasisSet, DensityMatrix, DensityMatrixLevel, ImportBatch,
    OrbitalSet, Structure,
)

from .protocol import EntityReference, ProtocolError
from .operation import OperationOutput
from ChemBlender.core.worker_protocol import _atomic_document
...
def _density_matrix_grid(context, request):
    from ChemBlender.core import evaluate_density_matrix_grid
...
def _esp_grid(context, request):
    from ChemBlender.core import evaluate_electrostatic_potential_grid
...
def _esp_from_orbitals_grid(context, request):
    from ChemBlender.core.wavefunction_observables import (
        derive_density_matrix_from_orbitals, evaluate_electrostatic_potential_grid,
    )
