...
- [x] **Step 2: Implement helper and CLI**
...
- [x] **Step 3: Verify YAML and tests**
...
- [x] **Step 1: Implement a disposable manifest copy**
...
- [x] **Step 2: Unit-test safe behavior**
...
- [x] **Step 1: Write valid/invalid version cases**
...
- [x] **Step 2: Implement one shared parser**
...
- [x] **Step 3: Increase artifact retention for tagged builds**
...
- [x] **Step 4: Run read-only local/static validation and commit**
...
- [x] **Step 1: Set exact alpha version and changelog entry**
...
- [x] **Step 2: Run full Wave 0 verification**
...
- [x] **Step 4: Commit candidate metadata**
...
- State: `completed`
- Tasks 1–6: `completed`
- Final full suite: 998 Passed, 28 Skipped, 0 Failed
- Blender: `5.1.2`
- Native validate/build: `Passed`
- Candidate:
  `chemblender-2.3.0-alpha.1.zip`, 27436521 bytes, SHA-256
  `a7672249e42611fa86112cbe300a6d4392b2468ade40ec46e5129582fdc26fe2`
- Artifact verification for `v2.3.0-alpha.1`: `Passed`
- Final isolated extension lifecycle: `Passed`
- Final independent reviews:
  specification and code quality `APPROVED`; all findings addressed.
- Remote CI: `Not Run`
- Tag, GitHub Release and workflow dispatch: `Not Run`
