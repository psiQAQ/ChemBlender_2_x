...
状态：进行中；Gemmi/spglib 基础与 ASE/pymatgen-core 周期结构、VASP scalar-field adapters 已完成，当前进入 band/DOS/projection schema。
...
11. 当前：band structure、DOS/PDOS、projection 与 Blender linked selection。
