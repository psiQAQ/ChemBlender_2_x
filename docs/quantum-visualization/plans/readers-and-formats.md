...
| 优先级 | 内容 | 主要验证 |
| --- | --- | --- |
| P0 | 已完成 registry、sniffing、`ParserReport`、MOL2 回归、cclib schema 3（含 vibration/excited state）与 IOData；继续 Gemmi/spglib adapter 边界 | 真实 fixture 能区分 supported、partial、unsupported、ambiguous |
