...
2026-09-09：L7正式瘦身已完成。manifest、依赖清单、staging和CI一致移除RDKit/Gemmi/scientific wheels，外部科学后端仍由`chemblender-prepare`管理。正式候选ZIP为2,830,321 bytes、109 members、SHA256 `4dabb6dc463a740846eca72b239e875689bfdd07e390b06e34d82f63cfcbabb5`；Blender 5.1.1私有profile完成安装、冷启动、重复reload、CBQ导入导出、纯Mesh编辑/Apply、结构/表面/体积View、保存重开、源移走及三个`.blend`资产检查，独立冷依赖验证确认Bundled NumPy可用且`rdkit`/`gemmi`均不可发现。全量2525项0 failures/0 errors/37 skips、140.477秒。紧急进程复核最终仅保留Blender PID 50440，重复MCP/Python链为0；清理期间累计终止79组已核验绝对路径的遗留链，未终止Codex或删除文件，当前Codex侧MCP stdio transport已关闭。下一阶段严格进入L8最终发行物、预算和逐物理量截图SOP。
