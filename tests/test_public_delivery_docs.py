...
class PublicDeliveryDocsTests(unittest.TestCase):
            ...
            self.assertEqual(
                ...
                {"docs/user/assets/2.5.0/blender-viewer.png", *(
                    'docs/user/assets/2.5-tutorials/' + name for name in (
                        ...
                        'grid-li-density.png', 'grid-derive-success.jpg', 'grid-derive-rejected.jpg', 'grid-prepare-inspect.jpg', 'grid-prepare-convert.jpg', 'grid-signed-volume.png', 'grid-sampling.png', 'grid-difference-refined.png', 'grid-primary-surface.jpg', 'grid-signed-surface.jpg',
    ...
    def test_real_body_links_resolve_to_sections_and_ancillary_downloads(self):
        ...
        self.assertEqual(content.count('<img '), 30)
