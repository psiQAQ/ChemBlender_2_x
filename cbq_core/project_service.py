...
from .sidecar import SidecarCompatibilityError
from .sidecar import SidecarIntegrityError
from .sidecar import SidecarNotFoundError
from .sidecar import _open_project_with_manifest
...
def sync_project_session_links_for_scenes(
    *, session, scenes, blend_path, previous_manifest_sha256=None,
):
    ...
    for scene in scenes:
        ...
        if any(
            ...
            and not (key == links.MANIFEST_HASH_KEY
                     and previous_manifest_sha256 is not None
                     and scene[key] == previous_manifest_sha256)
