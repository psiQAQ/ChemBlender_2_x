...
from .model_registry import MODEL_ENUMS
from .model_registry import model_type_from_tag
from .model_registry import model_type_tag
from .sidecar_migrations import CURRENT_MANIFEST_VERSION
from .sidecar_migrations import CURRENT_PROJECT_SCHEMA_VERSION
from .sidecar_migrations import HASHED_MANIFEST_VERSIONS
from .sidecar_migrations import V1_MANIFEST_VERSION
from .sidecar_migrations import HASHED_LEGACY_MANIFEST_VERSION
from .sidecar_migrations import LEGACY_MANIFEST_VERSION
from .sidecar_migrations import migrate_manifest
...
class _Decoder:
    ...
    def decode(self, value):
        ...
        if class_type is model.CIFEnvelope:
            ...
            value.setdefault("symmetry_rotations", None)
            value.setdefault("symmetry_translations", None)
...
def _open_project_with_manifest(
    ...
    *,
    ...
    if source_version in HASHED_MANIFEST_VERSIONS:
    ...
    if source_version not in HASHED_MANIFEST_VERSIONS:
    ...
    if (
        ...
        and not (
            ...
            in (LEGACY_MANIFEST_VERSION, HASHED_LEGACY_MANIFEST_VERSION, V1_MANIFEST_VERSION)
